...
https://github.com/NomaDamas/KICE_slayer_AI_Korean 에 대한 사이트 요약입니다:

본 연구에서는 최신 GPT 모델 (o1-preview, o1-mini, gpt-4o, gpt-4o-mini)을 대상으로 2024년도 수능 벤치마킹을 실시하였습니다. o1-preview 모델은 88점 (1등급)으로 가장 높은 성적을 기록하였으며, o1-mini, gpt-4o, gpt-4o-mini 모델은 각각 60점, 69점, 62점을 기록하였습니다.
GPT-4, Synatra-7b, GPT-3.5-16K 모델을 이용하여 2015년부터 2024년까지 10개년도 수능 데이터셋을 구축하고, 총 9개의 프롬프트 기법을 활용하여 벤치마킹을 진행한 결과, GPT-4 모델이 평균 68점으로 가장 높은 성능을 보였습니다.
GPT-4 모델은 영어 프롬프트에서 높은 성능을 보였으며, GPT-3.5-16K 모델은 형식 지정 프롬프트에서 높은 성능을 보였습니다. Synatra-7b 모델은 GPT-4와 GPT-3.5-16K 모델에 비해 상대적으로 낮은 성능을 보였습니다.
